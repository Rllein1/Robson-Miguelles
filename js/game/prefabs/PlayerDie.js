var PlayerDie=function(game){
    Phaser.Group.call(this, game);
};

PlayerDie.prototype=Object.create(Phaser.Group.prototype);
PlayerDie.prototype.constructor=PlayerDie;

PlayerDie.prototype.show = function(score){
    ...
    gameoverText=this.game.add.bitmapText(0,100, 'minecraftia', '  YOU DIED  ',50 );
...
PlayerDie.prototype.restart=function(){
